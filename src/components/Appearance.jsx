...
function Appearance() {
  ...
  return (
    <div className="p-8 max-md:p-5 w-full h-fit flex flex-col gap-5 text-lightBlackText/80">
      <form className="w-full flex flex-col gap-4 max-w-[300px] max-lg:max-w-full">
        {/* section title */}
        <h1 className="text-lg ">Default Theme</h1>
        <div className="w-full flex flex-col gap-1">
          <h1 className="text-sm font-normal">Set Theme</h1>
          <div className="w-fit max-lg:w-full h-fit flex items-start justify-start max-lg:flex-wrap gap-2">
            <label className="select-none max-lg:w-full flex items-center whitespace-nowrap justify-center cursor-pointer">
              ...
              <div className="w-[120px] max-lg:w-full h-[80px] border-2 border-stone-300/80 rounded-xl text-lightBlackText/50 peer-checked:text-mainColor peer-checked:border-mainColor/80 peer-checked:bg-mainColor/10 transition duration-200 flex flex-col items-center justify-center">
